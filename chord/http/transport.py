...
class HttpChordConnection(ChordConnection):
    ...
    def make_request(
        ...
        try:
            ...
            return self._marshaller.unmarshal(response, response_cls)
...
class HttpChordTransport(ChordTransport):
    """Facillitates Chord RPC over the HTTP protocol."""
    ...
    def create_connection(self, node_id: str) -> ChordConnection:
        return HttpChordConnection(self._marshaller, self._session, node_id)
